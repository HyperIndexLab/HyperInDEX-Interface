		...
		<div className="w-full max-w-3xl mx-auto">
			...
			{!address ? (
					...
					<div className="card-body">
						<div className="alert alert-warning shadow-lg">
							...
							<div>
								...
								<div className="text-sm">Please connect your wallet to participate in the campaign</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div className="space-y-6">
						...
						<div className="card-body">
							<div className="flex items-center gap-4 mb-4">
								...
								<div>
									...
									<p className="text-sm text-base-content/60">Bridge your assets to HashKey Chain</p>
								</div>
								{status?.is_bridge && (
							...
							{!status?.is_bridge && (
								<div className="flex flex-col sm:flex-row gap-3">
									<button
										onClick={() => handleGotoBridge('https://www.orbiter.finance/en?src_chain=42161&tgt_chain=177&src_token=ETH')}
					...
					{/* Task 2: Claim */}
					<div className={`card ${status?.is_bridge ? 'bg-base-200' : 'bg-base-200/50'} shadow-lg transition-all duration-300`}>
						<div className="card-body">
							<div className="flex items-center gap-4 mb-4">
								...
								<div>
									...
									<p className="text-sm text-base-content/60">Get your HSK token rewards</p>
								</div>
							...
							{!status?.is_claim_success && (
								<button 
									className={`btn ${status?.is_bridge ? 'btn-secondary' : 'btn-disabled'} w-full sm:w-auto`}
							...
							<div>
								...
								<div className="text-sm">
									...
									<Link 
										...
										target="_blank" 
										href={getEtherscanLink(chainId, status.txHash, 'transaction')}
									>
										View on Explorer
									</Link>
								</div>
